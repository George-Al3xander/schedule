import { typeSubjProps} from "../../types/types"

import { v4 as uuidv4 } from 'uuid';
import DisplayTime from "../DisplayTime";


const Subj = ({subj, subjIndex, dayIndex, deleteSubject, editStatus, getCurrentSubject, open}: typeSubjProps) => {
    ...
    <div className="absolute right-0 flex gap-2">
        <button disabled={editStatus == true ? true : false} onClick={() => {           
            getCurrentSubject(subj, subjIndex)
            open()
